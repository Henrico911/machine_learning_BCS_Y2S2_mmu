...
cluster_and_evaluate(X, num_clusters=3)

#Example of using the full iris dataset.
X_full = iris.data
cluster_and_evaluate(X_full, num_clusters=3, plot_results=False) # plot results is false because the full dataset is 4 dimensional and can't be plotted in 2d.